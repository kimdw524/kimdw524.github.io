...
type PostPageQuery = { readonly markdownRemark: { readonly html: string | null, readonly frontmatter: { readonly title: string | null, readonly slug: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly date: string | null } | null } | null, readonly prev: { readonly frontmatter: { readonly slug: string | null, readonly title: string | null } | null } | null, readonly next: { readonly frontmatter: { readonly slug: string | null, readonly title: string | null } | null } | null };
...
type SiteMetadataQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null, readonly siteUrl: string | null, readonly nickname: string | null, readonly description: string | null, readonly github: string | null } | null } | null };
...
type PostQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly frontmatter: { readonly slug: string | null } | null } }> } };

type TagQueryVariables = Exact<{ [key: string]: never; }>;


type TagQuery = { readonly allMarkdownRemark: { readonly group: ReadonlyArray<{ readonly tag: string | null }> } };
